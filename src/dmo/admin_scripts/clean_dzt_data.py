...
GERMAN_REGIONS = {
    ...
    "münchen": "Bavaria", "cologne": "North Rhine-Westphalia",
    "köln": "North Rhine-Westphalia", "frankfurt": "Hesse",
    ...
    "leipzig": "Saxony", "bremen": "Bremen", "dresden": "Saxony",
    "hannover": "Lower Saxony", "nuremberg": "Bavaria",
    "nürnberg": "Bavaria", "duisburg": "North Rhine-Westphalia",
    "bochum": "North Rhine-Westphalia", "bonn": "North Rhine-Westphalia",
    "bielefeld": "North Rhine-Westphalia", "mannheim": "Baden-Württemberg",
    "karlsruhe": "Baden-Württemberg", "wiesbaden": "Hesse",
    "münster": "North Rhine-Westphalia", "augsburg": "Bavaria",
    "aachen": "North Rhine-Westphalia", "krefeld": "North Rhine-Westphalia",
    "oberhausen": "North Rhine-Westphalia", "hagen": "North Rhine-Westphalia",
    "hamm": "North Rhine-Westphalia", "mainz": "Rhineland-Palatinate",
    "saarbrücken": "Saarland", "saarbruecken": "Saarland",
    "potsdam": "Brandenburg", "kiel": "Schleswig-Holstein",
    "magdeburg": "Saxony-Anhalt", "freiburg": "Baden-Württemberg",
    "rostock": "Mecklenburg-Vorpommern", "lübeck": "Schleswig-Holstein",
    "erfurt": "Thuringia", "heidelberg": "Baden-Württemberg",
    "darmstadt": "Hesse", "regensburg": "Bavaria",
    "würzburg": "Bavaria", "ingolstadt": "Bavaria",
    "ulm": "Baden-Württemberg", "wolfsburg": "Lower Saxony",
    "göttingen": "Lower Saxony", "koblenz": "Rhineland-Palatinate",
    "trier": "Rhineland-Palatinate", "passau": "Bavaria",
    "konstanz": "Baden-Württemberg", "bamberg": "Bavaria",
    "bayreuth": "Bavaria",
    "stralsund": "Mecklenburg-Vorpommern", "wismar": "Mecklenburg-Vorpommern",
    "quedlinburg": "Saxony-Anhalt", "weimar": "Thuringia",
    "rothenburg": "Bavaria", "neumünster": "Schleswig-Holstein",
    "flensburg": "Schleswig-Holstein", "cuxhaven": "Lower Saxony",
    "emden": "Lower Saxony", "wilhelmshaven": "Lower Saxony",
    "delmenhorst": "Lower Saxony", "Oldenburg": "Lower Saxony",
    "osnabrück": "Lower Saxony", "osnabrueck": "Lower Saxony",
    "minden": "North Rhine-Westphalia", "paderborn": "North Rhine-Westphalia",
    "siegen": "North Rhine-Westphalia", "wuppertal": "North Rhine-Westphalia",
    "solingen": "North Rhine-Westphalia", "remscheid": "North Rhine-Westphalia",
    "leverkusen": "North Rhine-Westphalia", "neuss": "North Rhine-Westphalia",
    "mönchengladbach": "North Rhine-Westphalia",
    "moenchengladbach": "North Rhine-Westphalia",
    "gelsenkirchen": "North Rhine-Westphalia", "herne": "North Rhine-Westphalia",
    "bottrop": "North Rhine-Westphalia",
    "bad_homburg": "Hesse", "offenbach": "Hesse",
    "hanau": "Hesse", "marburg": "Hesse",
    "giessen": "Hesse", "fulda": "Hesse",
    "kassel": "Hesse",
}
        ...
        if not dry_run:
            ...
            while True:
                rows = (await db.execute(
                    locality_sql, {"last_id": last_id, "limit": batch_size}
                )).fetchall()
                if not rows:
                    break
                for row in rows:
